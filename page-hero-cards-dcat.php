<?php
/**
 * Template Name: Hero Cards Generator - DCAT
 */
...
<head>
    ...
    <title>DCAT Hero Cards - <?php echo $display_date; ?></title>
    ...
    <style>
        ...
        /* The actual hero card - 9:16 ratio - DCAT BRANDING */
        .hero-card {
            width: 360px;
            height: 640px;
...
<div class="hero-page-container">
    ...
    <div class="date-picker-section">
        <h2>DCAT Top Topics Generator</h2>
        ...
        <p style="margin: 15px 0 0 0; color: #6b7280; font-size: 14px;">
            Showing DCAT-branded hero cards for <strong><?php echo $display_date; ?></strong>
        </p>
    </div>
        ...
        <div class="hero-card-wrapper">
            ...
            <div class="hero-card" id="hero-card-<?php echo get_the_ID(); ?>">
                ...
                <div class="hero-footer">
                    <div class="hero-powered-by">Powered by GovBrief</div>
            ...
            <button class="download-btn" onclick="downloadHeroCard(<?php echo get_the_ID(); ?>, 'dcat-<?php echo sanitize_title($headline); ?>')">
                ⬇️ Download DCAT PNG (1080x1920)
            </button>
        </div>
